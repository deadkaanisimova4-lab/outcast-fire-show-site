...
const Index = () => {
  ...
  const faq = [
    ...
    {
      question: "Как заказать артистов на праздник в Челябинске?",
      answer: "Позвоните нам или оставьте заявку на сайте — подберём программу артистов фаер-шоу под ваш праздник, обсудим детали и рассчитаем стоимость выступления."
    },
    {
      question: "Какую шоу-программу выбрать для праздника?",
      answer: "У нас несколько программ огненного шоу разной длительности и энергетики — от камерного парного выступления до масштабной постановки с несколькими артистами. Поможем выбрать программу под формат вашего мероприятия."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-2 animate-fade-in">
              ...
              <button onClick={() => scrollToSection('calendar')} className="flex items-center gap-3 w-full text-left py-3 px-4 hover:bg-primary/20 rounded-lg transition-colors">
      ...
      <section id="calendar" className="py-12 md:py-20 bg-gradient-to-b from-card to-black scroll-reveal">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-3 md:mb-4 fire-glow">Календарь доступности</h2>
          <p className="text-center text-sm sm:text-base text-muted-foreground mb-8 md:mb-12 px-4 max-w-2xl mx-auto">
            Проверьте, свободна ли дата вашего мероприятия
          </p>
