      ...
      <main className="pt-32 pb-16">
        <article className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <VenueCard
              number={2}
              title='Загородный комплекс "Усадьба"'
              info={{
                address: 'пос. Слава, ул. Ленина, 2',
            ...
            <VenueCard
              number={3}
              title='Банкетный зал "Алые паруса"'
              info={{
                address: 'ул. Новороссийская, 79/1',
                capacity: 'до 120 гостей',
                price: 'Банкет: от 1 600₽/чел',
                phone: '+7 (351) 345-67-89'
              }}
              features={[
                'Открытая площадка для огненного шоу',
                'Безопасное покрытие',
                '2 зала — малый и большой',
                'Удобный подъезд для оборудования'
              ]}
              experience="Уютное место для свадеб и корпоративов в городе. Два зала на 30 и 90 мест дают гибкость в выборе формата мероприятия."
            />

            <VenueCard
              number={4}
              title='Парк-отель "Еловое"'
              info={{
                address: 'Автодорога Чебаркуль — Миасс, 6 км, 5а, Чебаркуль',
              ...
              experience="Магическое место для свадеб и корпоративов на природе. Огненное шоу на свежем воздухе здесь смотрится невероятно. Важно: выезд платный (+3500₽ от Челябинска)."
            />
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Перед бронированием площадки обязательно уточните у администрации, разрешены ли огненные шоу. Мы можем помочь с оформлением всех документов!
                  </p>
                </div>
              </div>
            </div>
